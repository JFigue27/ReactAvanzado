...
export const Logo = props => (
  ...
  >
    <defs>
      <linearGradient id='prefix__editing-gradow-gradient' x2={1} y1={0.5} y2={0.5} gradientUnits='objectBoundingBox'>
        <stop offset={0} stopColor='#a50aa5' />
        <stop offset={1} stopColor='rgba(100%,69.71428571428572%,0%,0.846)' />
      </linearGradient>
      <filter id='prefix__editing-gradow-filter' x='-100%' y='-100%' width='300%' height='300%'>
        <feFlood floodColor='#e1e1db' result='flood' />
